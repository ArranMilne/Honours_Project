...
tokenizer = AutoTokenizer.from_pretrained("/users/40624421/sharedscratch/models/llama2-7b")
...
model_config = AutoConfig.from_pretrained("/users/40624421/sharedscratch/models/llama2-7b")



model = AutoModelForTokenClassification.from_pretrained("/users/40624421/sharedscratch/models/llama2-7b", num_labels=3, ignore_mismatched_sizes=True)
...
training_args = TrainingArguments(
    output_dir="/users/40624421/sharedscratch/datasets/skillspan_dataset/results",
